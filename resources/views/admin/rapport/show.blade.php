                        ...
                        <form action="{{ route('admin.dashboard') }}" method="GET">
                            <div class="search-container">
                                <input type="text" name="search" class="form-control search-input"
                                    placeholder="Search by name, destination or subject..." value="{{ request('search') }}">
                ...
                <div class="card">
                    ...
                    <div class="modal" id="rapportDetailsModal">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- Nouvelle section pour le document -->
                            <div class="mb-3">
                                <div class="modal-label">Document</div>
                                <div class="modal-value" id="modalRapportDocument">
                    ...
                    showDetailsBtns.forEach(btn => {
                        btn.addEventListener('click', function() {
                            ...
                            if (status === 'Completed') {
                                ...
                                modalStatus.innerHTML = '<span class="badge badge-pending">' + status +
                                    '</span>';
                            }
